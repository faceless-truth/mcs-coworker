    ...
    def _ask_claude(
        ...
        *,
        ...
        system = (
            ...
            f"OUTPUT FORMATTING\n"
            f"-----------------\n"
            f"- The body is rendered as HTML in Outlook. For emphasis use "
            f"<strong>...</strong> inline. Do NOT use **double asterisks** "
            f"or *single asterisks*; they render as literal characters in "
            f"the draft and look unprofessional.\n"
            f"- Do not use em-dashes or en-dashes for sentence "
            f"punctuation. Use a comma, semicolon, period, or colon as "
            f"appropriate.\n"
            f"- Hyphens (-) are fine for hyphenated words and numeric "
            f"ranges (e.g. FY2024-2025); do not substitute em-dashes (—) "
            f"or en-dashes (–) for them.\n"
            f"- Use plain prose paragraphs separated by blank lines. Use "
            f"bullet points only for genuine lists of three or more items; "
            f"a list of two reads better inline.\n"
            f"- Do not use markdown headings (#, ##, ###). The reply is an "
            f"email, not a document.\n\n"
