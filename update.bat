...
if not exist "%APP_DIR%ssets" mkdir "%APP_DIR%ssets"
if not exist "%APP_DIR%rontend_dist" mkdir "%APP_DIR%rontend_dist"
...
xcopy /E /I /Y "%REPO_DIR%assets\*" "%APP_DIR%ssets" >nul
echo       Done.
echo.

echo [4/4] Deploying frontend...
xcopy /E /I /Y "%FRONTEND_DIR%\dist\public\*" "%APP_DIR%rontend_dist" >nul
echo       Done.
echo.
